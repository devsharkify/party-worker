...
const st = StyleSheet.create({
  ...
  rank: { fontWeight: "700", color: colors.textMuted, fontSize: 17, fontFamily, lineHeight: lh(17) },
  ...
  tier: { fontSize: 11, fontWeight: "700", textTransform: "capitalize", fontFamily, lineHeight: lh(11) },
  pointsCol: { alignItems: "flex-end" },
  points: { fontWeight: "700", color: colors.navy, fontSize: 18, fontFamily, lineHeight: lh(18) },
  ...
  poolTitle: { color: "#fff", fontWeight: "700", fontSize: 15, fontFamily, lineHeight: lh(15) },
