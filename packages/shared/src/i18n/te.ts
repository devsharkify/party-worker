...
export const te: Catalog = {
  ...
  consent: {
    ...
    legalNote:
      "డిజిటల్ వ్యక్తిగత డేటా పరిరక్షణ చట్టం (DPDP) ప్రకారం మీ డేటాపై నియంత్రణ మీదే. వీటిని ప్రొఫైల్ నుండి ఎప్పుడైనా మార్చుకోవచ్చు.",
    skipNote: "సమ్మతి ఇవ్వకుండా కూడా కొనసాగవచ్చు. కొన్ని ఫీచర్లు పరిమితం కావచ్చు.",
  },
  membership: {
    title: "సభ్యత్వం",
  ...
  onboarding: {
    ...
    constituencyLabel: "అసెంబ్లీ నియోజకవర్గం",
    constituencyPlaceholder: "మీ నియోజకవర్గం ఎంచుకోండి",
    areaLabel: "ఏరియా / మండలం",
    areaPlaceholder: "మీ ఏరియా ఎంచుకోండి",
